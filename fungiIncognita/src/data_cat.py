...
FILE_PATH_PRIMARY_GENERATED = "data/raw/primary_data_generated.csv"
FILE_PATH_PRIMARY_EDITED = "data/raw/primary_data_edited.csv"
# file paths for secondary data
FILE_PATH_SECONDARY_GENERATED = "data/secondary_data_generated_with_names.csv"
